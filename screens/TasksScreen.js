      ...
      <View style={{ backgroundColor: '#FAFAFA', flex: 1 }}>
          <View style={{ flexWrap: 'wrap', flexDirection: 'row', justifyContent: 'space-around'}}>
            {this.props.tasks.map(task =>
              <View key={task.name} style={{...Styling.containers.card, marginTop: 24, alignItems: 'center', justifyContent: 'space-around', width: '40%', height: 150, backgroundColor: this.alreadyCompleted(task) ? '#75DAAD' : 'white' }}>
